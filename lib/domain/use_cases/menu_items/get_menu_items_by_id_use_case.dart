...
class GetMenuItemsByIdUseCase implements IUseCase<List<MenuItemModel>, List<int>> {
  ...
  Future<(List<MenuItemModel>, String?)> call(params) async {
    ...
    final filteredMenuItems = allMenuItems.where((e) => params.contains(e.menuItemId)).toList();
